"use strict";function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function _iterableToArray(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e)){for(var t=0,o=new Array(e.length);t<e.length;t++)o[t]=e[t];return o}}
...
document.onkeydown=preventDefaultForScrollKeys},enableScroll=function e(){window.removeEventListener&&window.removeEventListener("DOMMouseScroll",preventDefault,!1),window.onmousewheel=document.onmousewheel=null,window.onwheel=null,window.ontouchmove=null,document.onkeydown=null},hideOthers=function e(){var t=document.querySelectorAll(".speaker:not(.exclude)");TweenMax.staggerTo(t,.8,{scale:0,opacity:0,ease:Expo.easeInOut})},showOthers=function e(){var t=document.querySelectorAll(".speaker:not(.exclude)");TweenMax.staggerTo(t,.8,{scale:1,opacity:1,ease:Expo.easeInOut,onComplete:function e(){t.forEach(function(e){e.style.transform="none"})}})},hideTexts=function e(t,o){TweenMax.to([t,o],.5,{ease:Quart.easeIn,delay:0,y:20,opacity:0})},showTexts=function e(t,o){TweenMax.to([t,o],1,{ease:Expo.easeOut,delay:1,y:0,opacity:1})},showContentElems=function e(t,o){
// toggle the back control and scroll indicator.
var n=t.querySelector(".content-item__title"),r=t.querySelector(".content-item__text"),a=t.querySelector(".content-item__position"),i=document.querySelector(".content > .content__close");n.classList.contains("charmed")||(charming(n),n.classList.add("charmed"));// And access the spans/letters.
var s=n.querySelectorAll("span");TweenMax.to([i,r,a,contentPattern],.8,{ease:Expo.easeOut,delay:o,startAt:{y:60},y:0,opacity:1}),setTimeout(function(){s.forEach(function(e,t){var o=.05*t;TweenMax.to(e,.6,{ease:Back.easeOut,delay:o,startAt:{yPercent:"50%",opacity:0},yPercent:"0",opacity:1})})},1e3)},hideContentElems=function e(t,o){
// toggle the back control and scroll indicator.
var n=t.querySelector(".content-item__title"),r=t.querySelector(".content-item__text"),a=t.querySelector(".content-item__position"),i=document.querySelector(".content > .content__close"),s=n.querySelectorAll("span"),l=s.length;TweenMax.to([i,r,contentPattern,a],.8,{ease:Expo.easeIn,delay:0,startAt:null,y:60,opacity:0}),s.forEach(function(e,t){TweenMax.to(e,.3,{ease:Quart.easeIn,delay:.04*(l-t-1),yPercent:"50%",startAt:null,opacity:0})})},getSizePosition=function e(t,o){var n=!(1<arguments.length&&void 0!==o)||o,r=window.pageYOffset||docEl.scrollTop||body.scrollTop,a=window.pageXOffset||docEl.scrollLeft||body.scrollLeft;return{width:t.offsetWidth,height:t.offsetHeight,left:n?getOffset(t,"left")-a:getOffset(t,"left"),top:n?getOffset(t,"top")-r:getOffset(t,"top")}};//Disable/Enable Scroll Things
...
// options
itemSelector:".speaker",columnWidth:260,gutter:100,fitWidth:!0})}),speakers.forEach(function(t){var e=t.querySelector(".speaker__name");charming(e);var o=e.querySelectorAll("span");t.addEventListener("mouseenter",function(){animationHover(t,"mouseenter",o)}),t.addEventListener("mouseleave",function(){animationHover(t,"mouseleave",o)}),t.addEventListener("click",function(e){e.preventDefault(),openSpeaker(t)})}),closeTheSpeaker.addEventListener("click",function(e){e.preventDefault();// Get the content element respective to this grid item.
...
var o=t.querySelector(".speaker__bg"),n=t.querySelector(".speaker__wrap"),r=t.querySelector(".speaker__img"),a=t.querySelector(".speaker__name"),i=t.querySelector(".speaker__keynote"),s=document.querySelector(".speaker-grid");t.classList.add("exclude"),// Get the current scroll position.
...
var c=getSizePosition(t);console.log(c),o.style.width="".concat(c.width,"px"),o.style.height="".concat(c.height,"px"),o.style.left="".concat(c.left,"px"),o.style.top="".concat(c.top,"px"),// Set it to position fixed.
o.style.position="fixed",t.style.zIndex="1000";// Calculate the viewport diagonal. We will need to take this in consideration when scaling up the item´s bg element.
var u=Math.hypot(winsize.width,winsize.height);// Scale up the item´s bg element.
TweenMax.to(o,1.2,{ease:Expo.easeInOut,delay:.4,x:winsize.width/2-(c.left+c.width/2),y:winsize.height/2-(c.top+c.height/2),scaleX:u/c.width,scaleY:u/c.height});// Get the content element respective to this grid item.
...
var p=getSizePosition(n),y=getSizePosition(d.querySelector(".content-item__img"),!1);// Show the back control and scroll indicator and all the item´s content elements (1 second delay).
...
enableScroll(),t.isAnimating=!1}})}},closeItem=function e(t){if(!t.isAnimating){t.isAnimating=!0;var o=document.querySelector(".speaker-grid"),n=contents[activeSpeaker],r=n.querySelector(".content-item__img");// Get the content element respective to this grid item.
// Scroll to the previous scroll position before opening the item.
window.scrollTo(0,scrollPos),n.parentNode.style.position="fixed",// Disable page scrolling.
disableScroll(),// Showing the grid scroll.
o.classList.remove("grid-wrap--hidden");// The item that is open.
...
hideContentElems(n,0),// Set the grid´s image back to visible and hide the content´s one.
...
showTexts(l,c)}},animationHover=function e(t,o,n){if(990<window.innerWidth){var r=t.querySelector(".speaker__bg");// Scale up the bg element.
TweenMax.to(r,1,{ease:Expo.easeOut,scale:"mouseenter"===o?1.15:1}),n.forEach(function(t,e){TweenMax.to(t,.2,{ease:Quad.easeIn,delay:.1*e,yPercent:"mouseenter"===o?"-50%":"50%",opacity:0,onComplete:function e(){TweenMax.to(t,"mouseenter"===o?.6:1,{ease:"mouseenter"===o?Expo.easeOut:Elastic.easeOut.config(1,.4),startAt:{yPercent:"mouseenter"===o?"70%":"-70%",opacity:0},yPercent:"0%",opacity:1})}})})}};
